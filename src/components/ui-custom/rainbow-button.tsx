	...
	),
	{
		variants: {
			variant: {
				...
				outline:
					"border-2 border-transparent bg-[linear-gradient(#ffffff,#ffffff),linear-gradient(90deg,var(--color-1),var(--color-5),var(--color-3),var(--color-4),var(--color-2))] bg-[length:200%] text-accent-foreground [background-clip:padding-box,border-box] [background-origin:border-box] dark:text-white dark:bg-[linear-gradient(#0a0a0a,#0a0a0a),linear-gradient(90deg,var(--color-1),var(--color-5),var(--color-3),var(--color-4),var(--color-2))] before:absolute before:bottom-[-20%] before:left-1/2 before:z-0 before:h-1/5 before:w-3/5 before:-translate-x-1/2 before:animate-rainbow before:bg-[linear-gradient(90deg,var(--color-1),var(--color-5),var(--color-3),var(--color-4),var(--color-2))] before:[filter:blur(0.75rem)] after:absolute after:top-[-20%] after:left-1/2 after:z-0 after:h-1/5 after:w-3/5 after:-translate-x-1/2 after:animate-glow-pulse after:bg-[linear-gradient(180deg,rgba(0,0,0,0.35)_0%,rgba(0,0,0,0)_65%)] after:[filter:blur(0.75rem)]",
			},
			size: {
