...
export function VerticalBlogCard({ post }: BlogCardProps) {
	const card = (
		<Card className="flex flex-col rounded-2xl shadow-sm p-4 border border-border-tertiary bg-[rgba(248,249,252,1)] md:rounded-4xl lg:min-h-0 lg:h-full transition-shadow hover:shadow-md">
